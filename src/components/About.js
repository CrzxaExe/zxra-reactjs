    ...
    <div className="mt-[2.25rem] lg:mt-[1.6rem] -z-1">
      ...
      <section id="about" className="w-full py-2 -mt-2 text-xs text-tprime">
        <SyntaxHighlighter
          language="javascript"
          style={coy}
          customStyle={{ backgroundColor: "#083344", color: "#cffafe" }}
          className="text-white cz-white"
        >
          {codeString}
        </SyntaxHighlighter>
        ...
        <div>
          ...
          <p className="text-xs lg:text-sm whitespace-pre-line break-normal w-full px-4 mb-4">
            Sekelompok orang yang iseng dengan kemampuan di luar nalar yang
            memiliki tujuan yang sama untuk memudahkan orang lain dalam berbagai
            hal yang berhubungan dengan IT.
            <br />
            <br />
            <span className="text-active">Latar Belakang</span>
            <p className="px-4 pt-2 border-l border-tprime">
              Awalnya kami hanya ingin membuat project untuk memudahkan kami
              dalam membuat automisasi untuk sebuah aplikasi. Pada saat itu kami
              masih belum terpikirkan untuk membuat grup ini. Selang beberapa
              minggu setelahnya, salah satu dari kami mulai terpikirkan dan
              dinamai <span className="text-tsec font-bold px-1">Zxra</span>{" "}
              yang dipimpin oleh @CrzxaExe3
            </p>
            <br />
            <span className="text-active mt-3">Berdiri</span>
            <p className="px-4 pt-2 border-l border-tprime">
              12 Juli 2021, merupakan tanggal lahirnya grup ini
            </p>
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-xs lg:text-sm whitespace-pre-line break-normal w-full px-4">
            ...
            Dependensi Dev:
            ${Object.keys(pkgs.devDependencies)
              .map((r) => {
